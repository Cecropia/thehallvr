...
CS.mocap4 = CS.mocap4 || (function () {
    ...
    object.init = function (onComplete, envMap, clock) {
        ...
        mocaps = {
            head: jsonData[4].head.value,
            left: jsonData[4].left.value,
            right: jsonData[4].right.value
        }
    ...
    object.update = function () {
        ...
        if(mocaps && frame < 7050){
            ...
            torso.position.set(
                mocaps.head[frame].position.x - .05,
